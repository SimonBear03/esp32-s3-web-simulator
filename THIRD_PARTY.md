...
| Espressif ESP-IDF ESP32-S3 ADC documentation and calibration behavior | ESP-IDF `v4.4.7` public documentation and source reference | Apache-2.0 | No source code is copied; firmware-visible behavior and fixture output were used to validate an independent GPL behavioral model | Cross-checks ADC1 one-shot conversion and nominal calibration behavior |
